...
export class SharedService {
  ...
  public getAllStock(): Observable<Array<PublicModelDto>> {
    return this.httpClient.get(this.connectionstring + 'api/stock/all').pipe(map((res: any) => res));
  }
  ...
  public getFilteredStock(T: PublicFilterDto): Observable<Array<PublicModelDto>> {
    return this.httpClient.post(this.connectionstring + 'api/stock/filter', T).pipe(map((res: any) => res));
  }
  public getFastFilteredStock(T: FastFilterDto): Observable<Array<PublicModelDto>> {
    return this.httpClient.post(this.connectionstring + 'api/stock/fastfilter', T).pipe(map((res: any) => res));
  }
...
public enquire(T: EnquiryDto): Observable<any> {
  return this.httpClient.post(this.connectionstring + 'api/enquiry', T).pipe(map((res: any) => res));
}
public addNewEmail(email: any): Observable<any> {
  return this.httpClient.get(this.connectionstring + 'api/newClient/' + email).pipe(map((res: any) => res));
}
}
